...
#if(CY_PSOC3)
{
    ...
    ***************************************/
    const int32 CYCODE Thermocouple_coeffVT[][3] = {{899, -32313, 5427876},
                                                {5409254, 44258495, -18811504},
                                                {1491438, -32460854, 122848552},
                                                {21692561, 120318941, -210359013},
                                                {91742632, -207648731, 207615060},
                                                {214176392, 182975192, -118051605},
                                                {248408544, -80558514, 36068615},
                                                {116960923, 14071336, -4574432}};

const int32 CYCODE Thermocouple_voltRange[2] = {0, 20644};

const int8 CYCODE Thermocouple_xScaleVT[3] = {13, 14, 15};
const int8 CYCODE Thermocouple_coefScaleVT[3] = {8, 10, 8};
