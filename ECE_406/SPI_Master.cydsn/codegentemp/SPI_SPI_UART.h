...
#define SPI_SPI_CLOCK_MODE             (3u)
#define SPI_SPI_OVS_FACTOR             (8u)
...
#define SPI_SPI_BITS_ORDER             (0u)
#define SPI_SPI_TRANSFER_SEPARATION    (1u)
#define SPI_SPI_NUMBER_OF_SS_LINES     (4u)
#define SPI_SPI_RX_BUFFER_SIZE         (16u)
#define SPI_SPI_TX_BUFFER_SIZE         (16u)
...
#define SPI_SPI_BYTE_MODE_ENABLE       (1u)
