...
#define SDCard_SPIM_SPI_INTR_RX_MASK           (0x0u)
#define SDCard_SPIM_SPI_INTR_TX_MASK           (0x0u)
...
#define SDCard_SPIM_UART_MP_RX_ADDRESS         (0x2u)
#define SDCard_SPIM_UART_MP_RX_ADDRESS_MASK    (0xFFu)

#define SDCard_SPIM_UART_INTERRUPT_MODE        (0u)

#define SDCard_SPIM_UART_INTR_RX_MASK          (0x4u)
#define SDCard_SPIM_UART_INTR_TX_MASK          (0x0u)
...
#define SDCard_SPIM_UART_RX_BREAK_WIDTH        (11u)
...
/* UART specific functions */
    ...
    /* UART TX direction APIs */
        ...
        *******************************************************************************/
        ...
        void SDCard_SPIM_UartSendBreakBlocking(uint32 breakWidth);
...
***************************************/
    ...
    #define SDCard_SPIM_UART_DEFAULT_UART_RX_CTRL \
                    (SDCard_SPIM_GET_UART_RX_CTRL_MODE(SDCard_SPIM_UART_STOP_BITS_NUM)                    | \
                     ...
                     SDCard_SPIM_GET_UART_RX_CTRL_BREAK_WIDTH(SDCard_SPIM_UART_RX_BREAK_WIDTH)            | \
