...
/* Unconfigured pins */
#define SDCard_SPIM_REMOVE_RX_WAKE_SDA_MOSI_PIN  (1u)
#define SDCard_SPIM_REMOVE_RX_SDA_MOSI_PIN      (1u)
#define SDCard_SPIM_REMOVE_TX_SCL_MISO_PIN      (1u)
#define SDCard_SPIM_REMOVE_CTS_SCLK_PIN      (1u)
#define SDCard_SPIM_REMOVE_RTS_SS0_PIN      (1u)
...
/* Unconfigured pins */
#define SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN (0u == SDCard_SPIM_REMOVE_RX_WAKE_SDA_MOSI_PIN)
#define SDCard_SPIM_RX_SDA_MOSI_PIN     (0u == SDCard_SPIM_REMOVE_RX_SDA_MOSI_PIN)
#define SDCard_SPIM_TX_SCL_MISO_PIN     (0u == SDCard_SPIM_REMOVE_TX_SCL_MISO_PIN)
#define SDCard_SPIM_CTS_SCLK_PIN     (0u == SDCard_SPIM_REMOVE_CTS_SCLK_PIN)
#define SDCard_SPIM_RTS_SS0_PIN     (0u == SDCard_SPIM_REMOVE_RTS_SS0_PIN)
...
#if (SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN)
    #include "SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi.h"
#endif /* (SDCard_SPIM_RX_SDA_MOSI) */

#if (SDCard_SPIM_RX_SDA_MOSI_PIN)
    #include "SDCard_SPIM_uart_rx_i2c_sda_spi_mosi.h"
#endif /* (SDCard_SPIM_RX_SDA_MOSI) */

#if (SDCard_SPIM_TX_SCL_MISO_PIN)
    #include "SDCard_SPIM_uart_tx_i2c_scl_spi_miso.h"
#endif /* (SDCard_SPIM_TX_SCL_MISO) */

#if (SDCard_SPIM_CTS_SCLK_PIN)
    #include "SDCard_SPIM_uart_cts_spi_sclk.h"
#endif /* (SDCard_SPIM_CTS_SCLK) */

#if (SDCard_SPIM_RTS_SS0_PIN)
    #include "SDCard_SPIM_uart_rts_spi_ss0.h"
#endif /* (SDCard_SPIM_RTS_SS0_PIN) */
...
#if (SDCard_SPIM_RX_SDA_MOSI_PIN)
    #define SDCard_SPIM_RX_SDA_MOSI_HSIOM_REG   (*(reg32 *) SDCard_SPIM_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    #define SDCard_SPIM_RX_SDA_MOSI_HSIOM_PTR   ( (reg32 *) SDCard_SPIM_uart_rx_i2c_sda_spi_mosi__0__HSIOM)
    
    #define SDCard_SPIM_RX_SDA_MOSI_HSIOM_MASK      (SDCard_SPIM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define SDCard_SPIM_RX_SDA_MOSI_HSIOM_POS       (SDCard_SPIM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define SDCard_SPIM_RX_SDA_MOSI_HSIOM_SEL_GPIO  (SDCard_SPIM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define SDCard_SPIM_RX_SDA_MOSI_HSIOM_SEL_I2C   (SDCard_SPIM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define SDCard_SPIM_RX_SDA_MOSI_HSIOM_SEL_SPI   (SDCard_SPIM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define SDCard_SPIM_RX_SDA_MOSI_HSIOM_SEL_UART  (SDCard_SPIM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_UART)
    
#elif (SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG   (*(reg32 *) SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_PTR   ( (reg32 *) SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_MASK      (SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_POS       (SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_SEL_GPIO  (SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C   (SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI   (SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART  (SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_UART)    
   
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_INTCFG_REG (*(reg32 *) SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_INTCFG_PTR ( (reg32 *) SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define SDCard_SPIM_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK ((uint32) SDCard_SPIM_INTCFG_TYPE_MASK << \
                                                                           SDCard_SPIM_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins SDCard_SPIM_RX_SDA_MOSI_PIN or SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN present.*/
#endif /* (SDCard_SPIM_RX_SDA_MOSI_PIN) */

#if (SDCard_SPIM_TX_SCL_MISO_PIN)
    #define SDCard_SPIM_TX_SCL_MISO_HSIOM_REG   (*(reg32 *) SDCard_SPIM_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    #define SDCard_SPIM_TX_SCL_MISO_HSIOM_PTR   ( (reg32 *) SDCard_SPIM_uart_tx_i2c_scl_spi_miso__0__HSIOM)
    
    #define SDCard_SPIM_TX_SCL_MISO_HSIOM_MASK      (SDCard_SPIM_uart_tx_i2c_scl_spi_miso__0__HSIOM_MASK)
    #define SDCard_SPIM_TX_SCL_MISO_HSIOM_POS       (SDCard_SPIM_uart_tx_i2c_scl_spi_miso__0__HSIOM_SHIFT)
    #define SDCard_SPIM_TX_SCL_MISO_HSIOM_SEL_GPIO  (SDCard_SPIM_uart_tx_i2c_scl_spi_miso__0__HSIOM_GPIO)
    #define SDCard_SPIM_TX_SCL_MISO_HSIOM_SEL_I2C   (SDCard_SPIM_uart_tx_i2c_scl_spi_miso__0__HSIOM_I2C)
    #define SDCard_SPIM_TX_SCL_MISO_HSIOM_SEL_SPI   (SDCard_SPIM_uart_tx_i2c_scl_spi_miso__0__HSIOM_SPI)
    #define SDCard_SPIM_TX_SCL_MISO_HSIOM_SEL_UART  (SDCard_SPIM_uart_tx_i2c_scl_spi_miso__0__HSIOM_UART)
#endif /* (SDCard_SPIM_TX_SCL_MISO_PIN) */

#if (SDCard_SPIM_CTS_SCLK_PIN)
    #define SDCard_SPIM_CTS_SCLK_HSIOM_REG   (*(reg32 *) SDCard_SPIM_uart_cts_spi_sclk__0__HSIOM)
    #define SDCard_SPIM_CTS_SCLK_HSIOM_PTR   ( (reg32 *) SDCard_SPIM_uart_cts_spi_sclk__0__HSIOM)
    
    #define SDCard_SPIM_CTS_SCLK_HSIOM_MASK      (SDCard_SPIM_uart_cts_spi_sclk__0__HSIOM_MASK)
    #define SDCard_SPIM_CTS_SCLK_HSIOM_POS       (SDCard_SPIM_uart_cts_spi_sclk__0__HSIOM_SHIFT)
    #define SDCard_SPIM_CTS_SCLK_HSIOM_SEL_GPIO  (SDCard_SPIM_uart_cts_spi_sclk__0__HSIOM_GPIO)
    #define SDCard_SPIM_CTS_SCLK_HSIOM_SEL_I2C   (SDCard_SPIM_uart_cts_spi_sclk__0__HSIOM_I2C)
    #define SDCard_SPIM_CTS_SCLK_HSIOM_SEL_SPI   (SDCard_SPIM_uart_cts_spi_sclk__0__HSIOM_SPI)
    #define SDCard_SPIM_CTS_SCLK_HSIOM_SEL_UART  (SDCard_SPIM_uart_cts_spi_sclk__0__HSIOM_UART)
#endif /* (SDCard_SPIM_CTS_SCLK_PIN) */

#if (SDCard_SPIM_RTS_SS0_PIN)
    #define SDCard_SPIM_RTS_SS0_HSIOM_REG   (*(reg32 *) SDCard_SPIM_uart_rts_spi_ss0__0__HSIOM)
    #define SDCard_SPIM_RTS_SS0_HSIOM_PTR   ( (reg32 *) SDCard_SPIM_uart_rts_spi_ss0__0__HSIOM)
    
    #define SDCard_SPIM_RTS_SS0_HSIOM_MASK      (SDCard_SPIM_uart_rts_spi_ss0__0__HSIOM_MASK)
    #define SDCard_SPIM_RTS_SS0_HSIOM_POS       (SDCard_SPIM_uart_rts_spi_ss0__0__HSIOM_SHIFT)
    #define SDCard_SPIM_RTS_SS0_HSIOM_SEL_GPIO  (SDCard_SPIM_uart_rts_spi_ss0__0__HSIOM_GPIO)
    #define SDCard_SPIM_RTS_SS0_HSIOM_SEL_I2C   (SDCard_SPIM_uart_rts_spi_ss0__0__HSIOM_I2C)
    #define SDCard_SPIM_RTS_SS0_HSIOM_SEL_SPI   (SDCard_SPIM_uart_rts_spi_ss0__0__HSIOM_SPI)
#if !(SDCard_SPIM_CY_SCBIP_V0 || SDCard_SPIM_CY_SCBIP_V1)
    #define SDCard_SPIM_RTS_SS0_HSIOM_SEL_UART  (SDCard_SPIM_uart_rts_spi_ss0__0__HSIOM_UART)
...
/* Pins settings index. */
#define SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN_INDEX   (0u)
#define SDCard_SPIM_RX_SDA_MOSI_PIN_INDEX       (0u)
#define SDCard_SPIM_TX_SCL_MISO_PIN_INDEX       (1u)
#define SDCard_SPIM_CTS_SCLK_PIN_INDEX       (2u)
#define SDCard_SPIM_RTS_SS0_PIN_INDEX       (3u)
#define SDCard_SPIM_SS1_PIN_INDEX                  (4u)
#define SDCard_SPIM_SS2_PIN_INDEX                  (5u)
#define SDCard_SPIM_SS3_PIN_INDEX                  (6u)

/* Pins settings mask. */
#define SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN_MASK ((uint32) 0x01u << SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN_INDEX)
#define SDCard_SPIM_RX_SDA_MOSI_PIN_MASK     ((uint32) 0x01u << SDCard_SPIM_RX_SDA_MOSI_PIN_INDEX)
#define SDCard_SPIM_TX_SCL_MISO_PIN_MASK     ((uint32) 0x01u << SDCard_SPIM_TX_SCL_MISO_PIN_INDEX)
#define SDCard_SPIM_CTS_SCLK_PIN_MASK     ((uint32) 0x01u << SDCard_SPIM_CTS_SCLK_PIN_INDEX)
#define SDCard_SPIM_RTS_SS0_PIN_MASK     ((uint32) 0x01u << SDCard_SPIM_RTS_SS0_PIN_INDEX)
...
#if (SDCard_SPIM_TX_SCL_MISO_PIN)
    #define SDCard_SPIM_CHECK_TX_SCL_MISO_PIN_USED \
                (SDCard_SPIM_PIN_DM_ALG_HIZ != \
                    SDCard_SPIM_GET_P4_PIN_DM(SDCard_SPIM_uart_tx_i2c_scl_spi_miso_PC, \
                                                   SDCard_SPIM_uart_tx_i2c_scl_spi_miso_SHIFT))
#endif /* (SDCard_SPIM_TX_SCL_MISO_PIN) */

#if (SDCard_SPIM_RTS_SS0_PIN)
    #define SDCard_SPIM_CHECK_RTS_SS0_PIN_USED \
                (SDCard_SPIM_PIN_DM_ALG_HIZ != \
                    SDCard_SPIM_GET_P4_PIN_DM(SDCard_SPIM_uart_rts_spi_ss0_PC, \
                                                   SDCard_SPIM_uart_rts_spi_ss0_SHIFT))
#endif /* (SDCard_SPIM_RTS_SS0_PIN) */
...
/* Unconfigured SCB: scl signal */
    ...
    #define SDCard_SPIM_SET_I2C_SCL_DR(val) \
                            SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi_Write(val)

    #define SDCard_SPIM_SET_I2C_SCL_HSIOM_SEL(sel) \
                    SDCard_SPIM_SET_HSIOM_SEL(SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG,  \
                                                   SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_MASK, \
                                                   SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_POS,  \
                                                   (sel))

    #define SDCard_SPIM_WAIT_SCL_SET_HIGH  (0u == SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi_Read())

#elif (SDCard_SPIM_RX_SDA_MOSI_PIN)
    #define SDCard_SPIM_SET_I2C_SCL_DR(val) \
                            SDCard_SPIM_uart_rx_i2c_sda_spi_mosi_Write(val)


    #define SDCard_SPIM_SET_I2C_SCL_HSIOM_SEL(sel) \
                            SDCard_SPIM_SET_HSIOM_SEL(SDCard_SPIM_RX_SDA_MOSI_HSIOM_REG,  \
                                                           SDCard_SPIM_RX_SDA_MOSI_HSIOM_MASK, \
                                                           SDCard_SPIM_RX_SDA_MOSI_HSIOM_POS,  \
                                                           (sel))

    #define SDCard_SPIM_WAIT_SCL_SET_HIGH  (0u == SDCard_SPIM_uart_rx_i2c_sda_spi_mosi_Read())
...
#elif (SDCard_SPIM_TX_SCL_MISO_PIN)
    #define SDCard_SPIM_WAIT_SDA_SET_HIGH  (0u == SDCard_SPIM_uart_tx_i2c_scl_spi_miso_Read())
#else
...
/* Clear UART wakeup source */
    ...
    #define SDCard_SPIM_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) SDCard_SPIM_uart_rx_wake_i2c_sda_spi_mosi_ClearInterrupt(); \
            }while(0)
...
/* Unconfigured pins */
#define SDCard_SPIM_REMOVE_MOSI_SCL_RX_WAKE_PIN    SDCard_SPIM_REMOVE_RX_WAKE_SDA_MOSI_PIN
#define SDCard_SPIM_REMOVE_MOSI_SCL_RX_PIN         SDCard_SPIM_REMOVE_RX_SDA_MOSI_PIN
#define SDCard_SPIM_REMOVE_MISO_SDA_TX_PIN         SDCard_SPIM_REMOVE_TX_SCL_MISO_PIN
#ifndef SDCard_SPIM_REMOVE_SCLK_PIN
#define SDCard_SPIM_REMOVE_SCLK_PIN                SDCard_SPIM_REMOVE_CTS_SCLK_PIN
#endif /* SDCard_SPIM_REMOVE_SCLK_PIN */
#ifndef SDCard_SPIM_REMOVE_SS0_PIN
#define SDCard_SPIM_REMOVE_SS0_PIN                 SDCard_SPIM_REMOVE_RTS_SS0_PIN
#endif /* SDCard_SPIM_REMOVE_SS0_PIN */

/* Unconfigured pins */
#define SDCard_SPIM_MOSI_SCL_RX_WAKE_PIN   SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN
#define SDCard_SPIM_MOSI_SCL_RX_PIN        SDCard_SPIM_RX_SDA_MOSI_PIN
#define SDCard_SPIM_MISO_SDA_TX_PIN        SDCard_SPIM_TX_SCL_MISO_PIN
#ifndef SDCard_SPIM_SCLK_PIN
#define SDCard_SPIM_SCLK_PIN               SDCard_SPIM_CTS_SCLK_PIN
#endif /* SDCard_SPIM_SCLK_PIN */
#ifndef SDCard_SPIM_SS0_PIN
#define SDCard_SPIM_SS0_PIN                SDCard_SPIM_RTS_SS0_PIN
#endif /* SDCard_SPIM_SS0_PIN */

#if (SDCard_SPIM_MOSI_SCL_RX_WAKE_PIN)
    #define SDCard_SPIM_MOSI_SCL_RX_WAKE_HSIOM_REG     SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SDCard_SPIM_MOSI_SCL_RX_WAKE_HSIOM_PTR     SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SDCard_SPIM_MOSI_SCL_RX_WAKE_HSIOM_MASK    SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SDCard_SPIM_MOSI_SCL_RX_WAKE_HSIOM_POS     SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define SDCard_SPIM_MOSI_SCL_RX_WAKE_INTCFG_REG    SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SDCard_SPIM_MOSI_SCL_RX_WAKE_INTCFG_PTR    SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG

    #define SDCard_SPIM_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG
    #define SDCard_SPIM_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  SDCard_SPIM_RX_WAKE_SDA_MOSI_HSIOM_REG
#endif /* (SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN) */

#if (SDCard_SPIM_MOSI_SCL_RX_PIN)
    #define SDCard_SPIM_MOSI_SCL_RX_HSIOM_REG      SDCard_SPIM_RX_SDA_MOSI_HSIOM_REG
    #define SDCard_SPIM_MOSI_SCL_RX_HSIOM_PTR      SDCard_SPIM_RX_SDA_MOSI_HSIOM_PTR
    #define SDCard_SPIM_MOSI_SCL_RX_HSIOM_MASK     SDCard_SPIM_RX_SDA_MOSI_HSIOM_MASK
    #define SDCard_SPIM_MOSI_SCL_RX_HSIOM_POS      SDCard_SPIM_RX_SDA_MOSI_HSIOM_POS
#endif /* (SDCard_SPIM_MOSI_SCL_RX_PIN) */

#if (SDCard_SPIM_MISO_SDA_TX_PIN)
    #define SDCard_SPIM_MISO_SDA_TX_HSIOM_REG      SDCard_SPIM_TX_SCL_MISO_HSIOM_REG
    #define SDCard_SPIM_MISO_SDA_TX_HSIOM_PTR      SDCard_SPIM_TX_SCL_MISO_HSIOM_REG
    #define SDCard_SPIM_MISO_SDA_TX_HSIOM_MASK     SDCard_SPIM_TX_SCL_MISO_HSIOM_REG
    #define SDCard_SPIM_MISO_SDA_TX_HSIOM_POS      SDCard_SPIM_TX_SCL_MISO_HSIOM_REG
#endif /* (SDCard_SPIM_MISO_SDA_TX_PIN_PIN) */

#if (SDCard_SPIM_SCLK_PIN)
    #ifndef SDCard_SPIM_SCLK_HSIOM_REG
    #define SDCard_SPIM_SCLK_HSIOM_REG     SDCard_SPIM_CTS_SCLK_HSIOM_REG
    #define SDCard_SPIM_SCLK_HSIOM_PTR     SDCard_SPIM_CTS_SCLK_HSIOM_PTR
    #define SDCard_SPIM_SCLK_HSIOM_MASK    SDCard_SPIM_CTS_SCLK_HSIOM_MASK
    #define SDCard_SPIM_SCLK_HSIOM_POS     SDCard_SPIM_CTS_SCLK_HSIOM_POS
    #endif /* SDCard_SPIM_SCLK_HSIOM_REG */
#endif /* (SDCard_SPIM_SCLK_PIN) */

#if (SDCard_SPIM_SS0_PIN)
    #ifndef SDCard_SPIM_SS0_HSIOM_REG
    #define SDCard_SPIM_SS0_HSIOM_REG      SDCard_SPIM_RTS_SS0_HSIOM_REG
    #define SDCard_SPIM_SS0_HSIOM_PTR      SDCard_SPIM_RTS_SS0_HSIOM_PTR
    #define SDCard_SPIM_SS0_HSIOM_MASK     SDCard_SPIM_RTS_SS0_HSIOM_MASK
    #define SDCard_SPIM_SS0_HSIOM_POS      SDCard_SPIM_RTS_SS0_HSIOM_POS
    #endif /* SDCard_SPIM_SS0_HSIOM_REG */
#endif /* (SDCard_SPIM_SS0_PIN) */

#define SDCard_SPIM_MOSI_SCL_RX_WAKE_PIN_INDEX SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN_INDEX
#define SDCard_SPIM_MOSI_SCL_RX_PIN_INDEX      SDCard_SPIM_RX_SDA_MOSI_PIN_INDEX
#define SDCard_SPIM_MISO_SDA_TX_PIN_INDEX      SDCard_SPIM_TX_SCL_MISO_PIN_INDEX
#ifndef SDCard_SPIM_SCLK_PIN_INDEX
#define SDCard_SPIM_SCLK_PIN_INDEX             SDCard_SPIM_CTS_SCLK_PIN_INDEX
#endif /* SDCard_SPIM_SCLK_PIN_INDEX */
#ifndef SDCard_SPIM_SS0_PIN_INDEX
#define SDCard_SPIM_SS0_PIN_INDEX              SDCard_SPIM_RTS_SS0_PIN_INDEX
#endif /* SDCard_SPIM_SS0_PIN_INDEX */

#define SDCard_SPIM_MOSI_SCL_RX_WAKE_PIN_MASK SDCard_SPIM_RX_WAKE_SDA_MOSI_PIN_MASK
#define SDCard_SPIM_MOSI_SCL_RX_PIN_MASK      SDCard_SPIM_RX_SDA_MOSI_PIN_MASK
#define SDCard_SPIM_MISO_SDA_TX_PIN_MASK      SDCard_SPIM_TX_SCL_MISO_PIN_MASK
#ifndef SDCard_SPIM_SCLK_PIN_MASK
#define SDCard_SPIM_SCLK_PIN_MASK             SDCard_SPIM_CTS_SCLK_PIN_MASK
#endif /* SDCard_SPIM_SCLK_PIN_MASK */
#ifndef SDCard_SPIM_SS0_PIN_MASK
#define SDCard_SPIM_SS0_PIN_MASK              SDCard_SPIM_RTS_SS0_PIN_MASK
