...
void SDCard_SPIM_SpiPostEnable(void)
{
    ...
    if (SDCard_SPIM_CHECK_SPI_MASTER)
    {
        ...
        SDCard_SPIM_SET_HSIOM_SEL(SDCard_SPIM_CTS_SCLK_HSIOM_REG, SDCard_SPIM_CTS_SCLK_HSIOM_MASK,
                                       SDCard_SPIM_CTS_SCLK_HSIOM_POS, SDCard_SPIM_CTS_SCLK_HSIOM_SEL_SPI);
    #endif /* (SDCard_SPIM_CTS_SCLK_PIN) */

    #if (SDCard_SPIM_RTS_SS0_PIN)
        /* Set SCB SPI to drive output pin */
        SDCard_SPIM_SET_HSIOM_SEL(SDCard_SPIM_RTS_SS0_HSIOM_REG, SDCard_SPIM_RTS_SS0_HSIOM_MASK,
                                       SDCard_SPIM_RTS_SS0_HSIOM_POS, SDCard_SPIM_RTS_SS0_HSIOM_SEL_SPI);
...
void SDCard_SPIM_SpiStop(void)
{
    ...
    if (SDCard_SPIM_CHECK_SPI_MASTER)
    {
        ...
        SDCard_SPIM_uart_cts_spi_sclk_Write(SDCard_SPIM_GET_SPI_SCLK_INACTIVE);

        /* Set GPIO to drive output pin */
        SDCard_SPIM_SET_HSIOM_SEL(SDCard_SPIM_CTS_SCLK_HSIOM_REG, SDCard_SPIM_CTS_SCLK_HSIOM_MASK,
                                       SDCard_SPIM_CTS_SCLK_HSIOM_POS, SDCard_SPIM_CTS_SCLK_HSIOM_SEL_GPIO);
    #endif /* (SDCard_SPIM_uart_cts_spi_sclk_PIN) */

    #if (SDCard_SPIM_RTS_SS0_PIN)
        /* Set output pin state after block is disabled */
        SDCard_SPIM_uart_rts_spi_ss0_Write(SDCard_SPIM_GET_SPI_SS0_INACTIVE);

        /* Set GPIO to drive output pin */
        SDCard_SPIM_SET_HSIOM_SEL(SDCard_SPIM_RTS_SS0_HSIOM_REG, SDCard_SPIM_RTS_SS0_HSIOM_MASK,
                                       SDCard_SPIM_RTS_SS0_HSIOM_POS, SDCard_SPIM_RTS_SS0_HSIOM_SEL_GPIO);
    #endif /* (SDCard_SPIM_uart_rts_spi_ss0_PIN) */
